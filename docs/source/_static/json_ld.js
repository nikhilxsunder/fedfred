...
script.text = JSON.stringify({
    ...
    "description": "A feature-rich Python package for interacting with the Federal Reserve Bank of St. Louis Economic Database (FRED), with support for ALFRED vintages, GeoFRED maps, async access, caching, and typed DataFrame outputs.",
    ...
    "releaseNotes": "https://github.com/nikhilxsunder/fedfred/blob/main/CHANGELOG.md",
    ...
    "keywords": "FRED, ALFRED, GeoFRED, FRASER, Federal Reserve, economic data, Python, API client, pandas, time series"
});

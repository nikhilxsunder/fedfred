        ...
        translations: {
            en: {
                consentModal: {
                    ...
                    description: 'We use Google Analytics to understand how the documentation is used. No advertising, no data sales.',
                    acceptAllBtn: 'Accept',
                ...
                preferencesModal: {
                    ...
                    sections: [
                        {
                            title: 'Essential',
                            description: 'Required for basic site functionality (e.g. remembering this choice and your light/dark theme).',
                            linkedCategory: 'necessary'
                        },
                        {
                            title: 'Analytics',
                            description: 'Google Analytics — anonymous usage statistics that help prioritize documentation improvements.',
